...
try
{
    ...
    var m = JSON.parse(window.localStorage.getItem('mode'));
...
const userSlice = createSlice({
  ...
  reducers: {
    ...
    setMode:(state,action)=>{
      ...
      localStorage.setItem('mode',JSON.stringify(action.payload.mode));
...
export const { setUserLoginDetails, setSignOutState, setMessages, setMode } = userSlice.actions;
